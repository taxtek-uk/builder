  ...
  import { Plane, Box, Environment, ContactShadows } from '@react-three/drei';
  ...
  export function EnvironmentScene({ 
    ...
    return (
      <group>
        {/* HDR environment for reflections and GI */}
        <Environment
            files={
        ...
        {/* Soft contact shadows under scene */}
        <ContactShadows
          position={[0, 0.005, 0]}
          opacity={0.35}
          scale={scaleX * 3}
          ...
          far={5}
          resolution={1024}
          color={environmentMode === 'night' ? '#0b1020' : '#000000'}
        />
